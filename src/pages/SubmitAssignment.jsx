...
export default function SubmitAssignment() {
  ...
  const hoursLeft = Math.round(Math.abs(diff) / 3600000);
  ...
  const handleSubmit = async () => {
    ...
    if (isPastDeadline) {
      setError("Deadline has passed. Late submissions are not accepted.");
      return;
    }
        ...
        <div className="p-6 max-w-2xl mx-auto flex items-center justify-center min-h-[60vh]">
          <div className="text-center">
            ...
            <p className="text-slate-500 text-xs mb-6">
              Timestamp: <span className="text-white">{new Date().toLocaleString()}</span>
            </p>
            ...
            <button
              ...
              className="bg-gold-500 hover:bg-gold-600 text-navy-900 font-semibold px-6 py-2.5 rounded-lg text-sm transition-colors"
            >
              Back to Assignments
            </button>
          </div>
      ...
      <div className="p-6 max-w-2xl mx-auto">
        ...
        <div className="bg-navy-800 border border-navy-600 rounded-xl p-5 mb-5">
          <div className="flex items-start justify-between gap-3">
            <div>
              <span className="text-xs text-gold-400 bg-gold-500/10 border border-gold-500/20 rounded-md px-2 py-0.5 font-medium">
            ...
            <div className="shrink-0 text-right">
              ...
              <p className="text-white font-bold text-lg">{assignment.maxMarks}</p>
            </div>
          </div>

          {/* Deadline banner */}
          <div className={`flex items-center gap-3 mt-4 rounded-lg px-4 py-3 ${
            isPastDeadline
            ...
            <div>
              ...
              <p className="text-slate-400 text-xs">
                {deadline.toLocaleString("en-US", { weekday:"short", month:"short", day:"numeric", hour:"2-digit", minute:"2-digit" })}
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-slate-400 text-xs mt-1">
                  The deadline was {hoursLeft} hours ago. Contact your instructor if you require an extension.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-navy-800 border border-navy-600 rounded-xl p-5">
            ...
            <div
              ...
              className={`border-2 border-dashed rounded-xl p-10 text-center cursor-pointer transition-all ${
                dragOver
                  ...
                  : "border-navy-500 hover:border-gold-500/50 hover:bg-navy-700/30"
              }`}
            >
          ...
          <button
            ...
            disabled={!file || loading || isPastDeadline}
          ...
          {isPastDeadline && (
            <p className="text-center text-red-400 text-xs mt-2">Submissions are closed for this assignment.</p>
          )}
        </div>
      </div>
    </Layout>
